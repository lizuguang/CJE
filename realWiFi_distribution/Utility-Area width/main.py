...
def figure(rate_wifi_my, rate_wifi_oth):
    ...
    ax.set_xlabel(r'Area Width $d \ (km)$', font1)
    ...
    ax.grid()
    #ax.margins(0)
    plt.savefig('E:\\cloud files\\Students\\lizuguang\\my papers\\China Com\paper\\figures\\real_1.eps', dpi=300)
    plt.show()
...
def rate_wifi(d, filename, N):
    ...
    return rate_wifi_my, rate_wifi_oth, wifi_density
...
if __name__ == '__main__':
    ...
    rate_wifi_my, rate_wifi_oth, wifi_density, = rate_wifi(d, filename, N)
